...
public class Util {
    ...
    public static final String uploadedDate="uploaded_at_date";
    public static final String uploadedTime="uploaded_at_time";
    public static final String totalPrice="total_price";
    public static final String productDiscount="discount";
    ...
    public static final String notShipped="Not Shipped";

...
public class FavoriteProductsActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<Cart> options = new FirebaseRecyclerOptions.Builder<Cart>()
                .setQuery(favoritesListRef.child(currentOnlineUser.getPhone()),Cart.class)
                .build();
        ...
        FirebaseRecyclerAdapter<Cart , CartViewHolder> adapter= new FirebaseRecyclerAdapter<Cart, CartViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder holder, int position, @NonNull final Cart model) {
                ...
                holder.productQuantityTxt.setVisibility(View.GONE);
                    ...
                    public void onClick(View v) {
                        ...
                        builder.setItems(editProduct, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(final DialogInterface dialog, int which) {
                                ...
                                if(which==1){
                                    favoritesListRef.child(currentOnlineUser.getPhone())
                                            .child(model.getId())
                                            .removeValue()

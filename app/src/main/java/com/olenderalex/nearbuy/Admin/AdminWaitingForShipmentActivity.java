...
public class AdminWaitingForShipmentActivity extends AppCompatActivity {
    private RecyclerView ordersList;
    private DatabaseReference ordersRef;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_admin_waiting_for_shipment);
        ...
        ordersList=findViewById(R.id.list_waiting_for_shipment);
        ...
        FirebaseRecyclerOptions<Orders> options =
                new FirebaseRecyclerOptions.Builder<Orders>()
                        .setQuery(ordersRef.orderByChild(Util.shipmentStatus)
                                .equalTo(Util.readyForShipment), Orders.class)
                        .build();
        ...
        FirebaseRecyclerAdapter<Orders, AdminOrdersViewHolder> adapter =
                new FirebaseRecyclerAdapter<Orders, AdminOrdersViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull AdminOrdersViewHolder holder, final int position, @NonNull final Orders model) {
                        ...
                        /*
                         *       Update status for shipped order
                         */
                        holder.showOrdersBtn.setText("Is order Shipped?");
                        holder.showOrdersBtn.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                AlertDialog.Builder builder = new AlertDialog.Builder(AdminWaitingForShipmentActivity.this);
                                ...
                                builder.setItems(isShipped, new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        if (which == 0) {
                                            ...
                                            Toast.makeText(AdminWaitingForShipmentActivity.this
                                                    , "Order removed from waiting list", Toast.LENGTH_LONG).show();
                                        } else {
    ...
    private void updateShipmentStatus(final String orderNumber) {
        ...
        orderStatusMap.put(Util.shipmentStatus, Util.shipped);

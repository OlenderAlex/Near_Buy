        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(!(snapshot.child(parentDbName).child(phone).exists())){
                    ...
                    RootRef.child(parentDbName).child(phone).updateChildren(userDataMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()){
                                Toast.makeText(UserRegistrationActivity.this ,"Your account created.",Toast.LENGTH_LONG).show();
                                loadingBar.dismiss();

                                Intent intentLogin =new Intent(UserRegistrationActivity.this,MainActivity.class);
                                startActivity(intentLogin);
                            }else
                                Toast.makeText(UserRegistrationActivity.this ,"Ooops ,there are some problems. Please try again",Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(UserRegistrationActivity.this ,"This phone number already exists",Toast.LENGTH_LONG).show();
                    loadingBar.dismiss();
                }
            }
